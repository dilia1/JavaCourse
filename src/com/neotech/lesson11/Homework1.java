...
public class Homework1 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * in the first row, 0 spaces, (2 * 5) - 1 stars in the second row, 1 spaces, (2
		 * * 4) - 1 stars in the third row, 2 spaces, (2 * 3) - 1 stars in the fourth
		 * row, 3 spaces, (2 * 2) - 1 stars in the fifth row, 4 spaces, (2 * 1) - 1
		 * stars
		 */    
